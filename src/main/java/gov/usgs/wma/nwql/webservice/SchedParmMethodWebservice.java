...
import gov.usgs.wma.nwql.service.SchedParmMethodService;
 ...
 * @author kmschoep
 */
@Path("parmmethod/data")
public class SchedParmMethodWebservice {
	...
	private SchedParmMethodService schedParmMethodService = new SchedParmMethodService();
	...
	public Integer getTotalCount(@Context final HttpServletRequest request) {
		@SuppressWarnings("unchecked")
			Integer result = schedParmMethodService.getRowCount();
			return result;
	}
	...
	public StreamingOutput streamData(
		...
		return new StreamingOutput() {
			...
			public void write(OutputStream output) throws IOException, WebApplicationException {
				schedParmMethodService.streamData(output, format);
			}
		};
	}
}
